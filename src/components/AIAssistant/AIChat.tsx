...
const ACTION_LABELS: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
  ...
  REGISTER_FIELD_TYPE: { label: 'Зарег. тип поля',     icon: <Plus className="w-3.5 h-3.5" />,         color: 'bg-blue-500/10 text-blue-600 hover:bg-blue-500/20 border-blue-500/30' },
  REGISTER_BLOCK_TYPE: { label: 'Зарег. тип блока',    icon: <Plus className="w-3.5 h-3.5" />,         color: 'bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20 border-emerald-500/30' },
